...
public class DataGenerator implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        menuRepository.save(Menu.create("./images/xxx", "기네스콰트로치즈와퍼", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, premium, MenuType.BURGER));
        menuRepository.save(Menu.create("./images/xxx", "기네스머쉬룸와퍼", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, premium, MenuType.BURGER));
        menuRepository.save(Menu.create("./images/xxx", "기네스와퍼", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, premium, MenuType.BURGER));
        menuRepository.save(Menu.create("./images/xxx", "몬스터와퍼", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, premium, MenuType.BURGER));
        ...
        menuRepository.save(Menu.create("./images/xxx", "리얼 와퍼", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, whopper, MenuType.BURGER));
        ...
        menuRepository.save(Menu.create("./images/xxx", "고추장 버섯불고기버거", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, juniorAndBurger, MenuType.BURGER));
        menuRepository.save(Menu.create("./images/xxx", "직화소불고기버거", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, juniorAndBurger, MenuType.BURGER));
        menuRepository.save(Menu.create("./images/xxx", "통새우와퍼주니어", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, juniorAndBurger, MenuType.BURGER));
        menuRepository.save(Menu.create("./images/xxx", "콰트로치즈와퍼주니어", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, juniorAndBurger, MenuType.BURGER));
        menuRepository.save(Menu.create("./images/xxx", "와퍼주니어", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, juniorAndBurger, MenuType.BURGER));
        ...
        menuRepository.save(Menu.create("./images/xxx", "크라미모짜볼", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, side, MenuType.SIDE));
        menuRepository.save(Menu.create("./images/xxx", "코코넛쉬림프+스위트칠리소스", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, side, MenuType.SIDE));
        menuRepository.save(Menu.create("./images/xxx", "너겟킹", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, side, MenuType.SIDE));
        menuRepository.save(Menu.create("./images/xxx", "치즈프라이", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, side, MenuType.SIDE));
        menuRepository.save(Menu.create("./images/xxx", "프렌치프라이", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, side, MenuType.SIDE));
        menuRepository.save(Menu.create("./images/xxx", "시즈닝", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, side, MenuType.SIDE));
        menuRepository.save(Menu.create("./images/xxx", "어니언링", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, side, MenuType.SIDE));
        menuRepository.save(Menu.create("./images/xxx", "코올슬로", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, side, MenuType.SIDE));
        ...
        menuRepository.save(Menu.create("./images/xxx", "코카콜라", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, beverageAndDessert, MenuType.BEVERAGE));
        menuRepository.save(Menu.create("./images/xxx", "코카콜라 제로", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, beverageAndDessert, MenuType.BEVERAGE));
        menuRepository.save(Menu.create("./images/xxx", "스프라이트", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, beverageAndDessert, MenuType.BEVERAGE));
        ...
        menuRepository.save(Menu.create("./images/xxx", "콘 아이스크림", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, beverageAndDessert, MenuType.DESSERT));
        menuRepository.save(Menu.create("./images/xxx", "컵 아이스크림", 8500, TierStatus.NORMAL, ActivationStatus.ACTIVATED, beverageAndDessert, MenuType.DESSERT));
    }
}
